...
void AGameAIController::SetDesiredRotation(const struct FRotator& TargetDesiredRotation, bool InLockDesiredRotation, bool InUnlockWhenReached, float InterpolationTime)
{
	...
	SetDesiredRotation_Params.InterpolationTime = InterpolationTime;
...
void AGameAIController::TestLogAIToConsole(int32_t Verbosity)
{
	...
	TestLogAIToConsole_Params.Verbosity = Verbosity;
...
void AGamePlayerController::ClientColorFade(const struct FColor& _FadeColor, uint8_t _FromAlpha, uint8_t _ToAlpha, float _FadeTime)
{
	...
	ClientColorFade_Params._FromAlpha = _FromAlpha;
	ClientColorFade_Params._ToAlpha = _ToAlpha;
	ClientColorFade_Params._FadeTime = _FadeTime;
...
// [0x01020DC1] (FUNC_Final | FUNC_Net | FUNC_NetReliable | FUNC_Simulated | FUNC_Native | FUNC_Event | FUNC_Public | FUNC_NetClient | FUNC_AllFlags)
// Parameter Info:
...
void AGamePlayerController::eventClientPlayMovie(const class FString& MovieName, int32_t InStartOfRenderingMovieFrame, int32_t InEndOfRenderingMovieFrame, bool bRestrictPausing, bool bPlayOnceFromStream, bool bOnlyBackButtonSkipsMovie)
{
	...
	ClientPlayMovie_Params.InStartOfRenderingMovieFrame = InStartOfRenderingMovieFrame;
	ClientPlayMovie_Params.InEndOfRenderingMovieFrame = InEndOfRenderingMovieFrame;
...
void AGamePlayerController::ShowLoadingMovie(bool bShowMovie, bool bPauseAfterHide, float PauseDuration, float KeepPlayingDuration, bool bOverridePreviousDelays)
{
	...
	ShowLoadingMovie_Params.PauseDuration = PauseDuration;
	ShowLoadingMovie_Params.KeepPlayingDuration = KeepPlayingDuration;
...
// [0x00824202] (FUNC_Defined | FUNC_Exec | FUNC_OptionalParm | FUNC_Public | FUNC_HasDefaults | FUNC_AllFlags)
// Parameter Info:
...
struct FVector AGameCrowdAgent::eventGeneratePathToActor(class AActor* Goal, float WithinDistance, bool bAllowPartialPath)
{
	...
	GeneratePathToActor_Params.WithinDistance = WithinDistance;
...
void AGameCrowdAgent::eventHandleBehaviorEvent(uint8_t EventType, class AActor* InInstigator, bool bViralCause, bool bPropagateViralFlag)
{
	...
	HandleBehaviorEvent_Params.EventType = EventType;
...
void AGameCrowdAgent::DisplayDebug(class AHUD* HUD, float& out_YL, float& out_YPos)
{
	...
	DisplayDebug_Params.out_YL = out_YL;
	DisplayDebug_Params.out_YPos = out_YPos;

	this->ProcessEvent(uFnDisplayDebug, &DisplayDebug_Params, nullptr);

	out_YL = DisplayDebug_Params.out_YL;
	out_YPos = DisplayDebug_Params.out_YPos;
}
...
class AGameCrowdBehaviorPoint* UGameCrowdAgentBehavior::TriggerCrowdBehavior(uint8_t EventType, class AActor* Instigator, const struct FVector& AtLocation, float InRange, float InDuration, class AActor* BaseActor, bool bRequireLOS)
{
	...
	TriggerCrowdBehavior_Params.EventType = EventType;
	...
	TriggerCrowdBehavior_Params.InRange = InRange;
	TriggerCrowdBehavior_Params.InDuration = InDuration;
...
// [0x00C24102] (FUNC_Defined | FUNC_Simulated | FUNC_OptionalParm | FUNC_Public | FUNC_HasOutParms | FUNC_HasDefaults | FUNC_AllFlags)
// Parameter Info:
// uint32_t                       bPersistent                    (CPF_OptionalParm | CPF_Parm)
// class TArray<struct FCrowdSpawnerPlayerInfo> PlayerInfo                     (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)

void AGameCrowdDestination::DrawDebug(bool bPersistent, class TArray<struct FCrowdSpawnerPlayerInfo>& PlayerInfo)
{
	static UFunction* uFnDrawDebug = nullptr;
...
void AGameCrowdDestination::PrioritizeSpawnPoint(float MaxSpawnDist, class TArray<struct FCrowdSpawnerPlayerInfo>& PlayerInfo)
{
	...
	PrioritizeSpawnPoint_Params.MaxSpawnDist = MaxSpawnDist;
...
bool AGameCrowdDestination::AnalyzeSpawnPoint(float MaxSpawnDistSq, bool bForceNavMeshPathing, class UNavigationHandle* NavHandle, class TArray<struct FCrowdSpawnerPlayerInfo>& PlayerInfo)
{
	...
	AnalyzeSpawnPoint_Params.MaxSpawnDistSq = MaxSpawnDistSq;
...
bool AGameCrowdDestination::AtCapacity(uint8_t CheckCnt)
{
	...
	AtCapacity_Params.CheckCnt = CheckCnt;
...
bool AGameCrowdPopulationManager::Warmup(int32_t WarmupNum, struct FCrowdSpawnInfoItem& Item)
{
	...
	Warmup_Params.WarmupNum = WarmupNum;
...
class AGameCrowdAgent* AGameCrowdPopulationManager::SpawnAgentByIdx(int32_t SpawnerIdx, class AGameCrowdDestination* SpawnLoc)
{
	...
	SpawnAgentByIdx_Params.SpawnerIdx = SpawnerIdx;
...
void AGameCrowdPopulationManager::AnalyzeSpawnPoints(int32_t StartIndex, int32_t NumToUpdate, struct FCrowdSpawnInfoItem& Item)
{
	...
	AnalyzeSpawnPoints_Params.NumToUpdate = NumToUpdate;
...
void AGameCrowdPopulationManager::eventPrioritizeSpawnPoints(float DeltaTime, struct FCrowdSpawnInfoItem& Item)
{
	...
	PrioritizeSpawnPoints_Params.DeltaTime = DeltaTime;
...
bool AGameCrowdPopulationManager::eventUpdateSpawner(float DeltaTime, struct FCrowdSpawnInfoItem& Item)
{
	...
	UpdateSpawner_Params.DeltaTime = DeltaTime;
...
void AGameCrowdPopulationManager::UpdateAllSpawners(float DeltaTime)
{
	...
	UpdateAllSpawners_Params.DeltaTime = DeltaTime;
...
void AGameExplosionActor::SpecialCringeEffectsFor(class AActor* Victim, float VictimDist)
{
	...
	SpecialCringeEffectsFor_Params.VictimDist = VictimDist;
...
void AGameExplosionActor::SpecialPawnEffectsFor(class AGamePawn* VictimPawn, float VictimDist)
{
	...
	SpecialPawnEffectsFor_Params.VictimDist = VictimDist;
...
bool ADebugCameraController::NativeInputKey(int32_t ControllerId, const class FName& Key, uint8_t Event, float AmountDepressed, bool bGamepad)
{
	...
	NativeInputKey_Params.ControllerId = ControllerId;
	memcpy_s(&NativeInputKey_Params.Key, sizeof(NativeInputKey_Params.Key), &Key, sizeof(Key));
	NativeInputKey_Params.Event = Event;
	NativeInputKey_Params.AmountDepressed = AmountDepressed;
...
void AMobileHUD::DrawMobileDebugString(float XPos, float YPos, const class FString& Str)
{
	...
	DrawMobileDebugString_Params.XPos = XPos;
	DrawMobileDebugString_Params.YPos = YPos;
...
bool UMobileInputZone::OnProcessSlide(class UMobileInputZone* Zone, uint8_t EventType, int32_t SlideValue, const struct FVector2D& ViewportSize)
{
	...
	OnProcessSlide_Params.EventType = EventType;
	OnProcessSlide_Params.SlideValue = SlideValue;
...
bool UMobileInputZone::OnDoubleTapDelegate(class UMobileInputZone* Zone, uint8_t EventType, const struct FVector2D& TouchLocation)
{
	...
	OnDoubleTapDelegate_Params.EventType = EventType;
...
bool UMobileInputZone::OnTapDelegate(class UMobileInputZone* Zone, uint8_t EventType, const struct FVector2D& TouchLocation)
{
	...
	OnTapDelegate_Params.EventType = EventType;
...
bool UMobileInputZone::OnProcessInputDelegate(class UMobileInputZone* Zone, float DeltaTime, int32_t Handle, uint8_t EventType, const struct FVector2D& TouchLocation)
{
	...
	OnProcessInputDelegate_Params.DeltaTime = DeltaTime;
	OnProcessInputDelegate_Params.Handle = Handle;
	OnProcessInputDelegate_Params.EventType = EventType;
...
void UMobileMenuObject::RenderObject(class UCanvas* Canvas, float DeltaTime)
{
	...
	RenderObject_Params.DeltaTime = DeltaTime;
...
void UMobileMenuObject::SetCanvasPos(class UCanvas* Canvas, float OffsetX, float OffsetY)
{
	...
	SetCanvasPos_Params.OffsetX = OffsetX;
	SetCanvasPos_Params.OffsetY = OffsetY;
...
void UMobileMenuObject::InitMenuObject(class UMobilePlayerInput* PlayerInput, class UMobileMenuScene* Scene, int32_t ScreenWidth, int32_t ScreenHeight, bool bIsFirstInitialization)
{
	...
	InitMenuObject_Params.ScreenWidth = ScreenWidth;
	InitMenuObject_Params.ScreenHeight = ScreenHeight;
...
void UMobileMenuObject::eventGetRealPosition(float& PosX, float& PosY)
{
	...
	GetRealPosition_Params.PosX = PosX;
	GetRealPosition_Params.PosY = PosY;

	this->ProcessEvent(uFnGetRealPosition, &GetRealPosition_Params, nullptr);

	PosX = GetRealPosition_Params.PosX;
	PosY = GetRealPosition_Params.PosY;
}
...
bool UMobileMenuObject::eventOnTouch(uint8_t EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	...
	OnTouch_Params.DeltaTime = DeltaTime;
...
bool UMobileMenuScene::eventOnSceneTouch(uint8_t EventType, float TouchX, float TouchY, bool bInside)
{
	...
	OnSceneTouch_Params.TouchX = TouchX;
	OnSceneTouch_Params.TouchY = TouchY;
...
void UMobileMenuScene::PreRenderMenuObject(class UMobileMenuObject* MenuObject, class UCanvas* Canvas, float RenderDelta)
{
	...
	PreRenderMenuObject_Params.RenderDelta = RenderDelta;
...
void UMobilePlayerInput::PreClientTravel(const class FString& PendingURL, uint8_t TravelType, bool bIsSeamlessTravel)
{
	...
	PreClientTravel_Params.TravelType = TravelType;
...
void UMobilePlayerInput::eventRenderMenus(class UCanvas* Canvas, float RenderDelta)
{
	...
	RenderMenus_Params.RenderDelta = RenderDelta;
...
bool UMobilePlayerInput::ProcessWorldTouch(class UMobileInputZone* Zone, uint8_t EventType, const struct FVector2D& TouchLocation)
{
	...
	ProcessWorldTouch_Params.EventType = EventType;
...
void UMobilePlayerInput::SendInputAxis(const class FName& Key, float Delta, float DeltaTime)
{
	...
	SendInputAxis_Params.Delta = Delta;
	SendInputAxis_Params.DeltaTime = DeltaTime;
...
void UMobilePlayerInput::SendInputKey(const class FName& Key, uint8_t Event, float AmountDepressed)
{
	...
	SendInputKey_Params.Event = Event;
	SendInputKey_Params.AmountDepressed = AmountDepressed;
...
void UMobilePlayerInput::ConditionalUpdateInputZones(int32_t NewViewportX, int32_t NewViewportY, int32_t NewViewportSizeX, int32_t NewViewportSizeY)
{
	...
	ConditionalUpdateInputZones_Params.NewViewportX = NewViewportX;
	ConditionalUpdateInputZones_Params.NewViewportY = NewViewportY;
	ConditionalUpdateInputZones_Params.NewViewportSizeX = NewViewportSizeX;
	ConditionalUpdateInputZones_Params.NewViewportSizeY = NewViewportSizeY;
...
void UMobilePlayerInput::OnInputTouch(int32_t Handle, uint8_t Type, const struct FVector2D& TouchLocation, float DeviceTimestamp, int32_t TouchpadIndex)
{
	...
	OnInputTouch_Params.Handle = Handle;
	OnInputTouch_Params.Type = Type;
	memcpy_s(&OnInputTouch_Params.TouchLocation, sizeof(OnInputTouch_Params.TouchLocation), &TouchLocation, sizeof(TouchLocation));
	OnInputTouch_Params.DeviceTimestamp = DeviceTimestamp;
	OnInputTouch_Params.TouchpadIndex = TouchpadIndex;
...
bool UMobilePlayerInput::OnPreviewTouch(float X, float Y, int32_t TouchpadIndex)
{
	...
	OnPreviewTouch_Params.X = X;
	OnPreviewTouch_Params.Y = Y;
	OnPreviewTouch_Params.TouchpadIndex = TouchpadIndex;
...
void UMobilePlayerInput::eventPlayerInput(float DeltaTime)
{
	...
	PlayerInput_Params.DeltaTime = DeltaTime;
...
void UMobilePlayerInput::ProcessMobileInput(float DeltaTime)
{
	...
	ProcessMobileInput_Params.DeltaTime = DeltaTime;
...
void UGameThirdPersonCamera::SetFocusOnActor(class AActor* FocusActor, const class FName& FocusBoneName, const struct FVector2D& InterpSpeedRange, const struct FVector2D& InFocusFOV, float CameraFOV, bool bAlwaysFocus, bool bAdjustCamera, bool bIgnoreTrace, float FocusPitchOffsetDeg)
{
	...
	SetFocusOnActor_Params.CameraFOV = CameraFOV;
	...
	SetFocusOnActor_Params.FocusPitchOffsetDeg = FocusPitchOffsetDeg;
...
void UGameThirdPersonCamera::SetFocusOnLoc(const struct FVector& FocusWorldLoc, const struct FVector2D& InterpSpeedRange, const struct FVector2D& InFocusFOV, float CameraFOV, bool bAlwaysFocus, bool bAdjustCamera, bool bIgnoreTrace, float FocusPitchOffsetDeg)
{
	...
	SetFocusOnLoc_Params.CameraFOV = CameraFOV;
	...
	SetFocusOnLoc_Params.FocusPitchOffsetDeg = FocusPitchOffsetDeg;
...
void UGameThirdPersonCamera::BeginTurn(int32_t StartAngle, int32_t EndAngle, float TimeSec, float DelaySec, bool bAlignTargetWhenFinished)
{
	...
	BeginTurn_Params.DelaySec = DelaySec;
...
void UGameSpecialMove::InitSpecialMoveFlags(int32_t& out_Flags)
{
	...
	InitSpecialMoveFlags_Params.out_Flags = out_Flags;

	this->ProcessEvent(uFnInitSpecialMoveFlags, &InitSpecialMoveFlags_Params, nullptr);

	out_Flags = InitSpecialMoveFlags_Params.out_Flags;
}
...
bool UGameStatsAggregator::GetAggregateMappingIDs(int32_t EventID, int32_t& AggregateID, int32_t& TargetAggregateID)
{
	...
	GetAggregateMappingIDs_Params.EventID = EventID;
	GetAggregateMappingIDs_Params.AggregateID = AggregateID;
	GetAggregateMappingIDs_Params.TargetAggregateID = TargetAggregateID;

	this->ProcessEvent(uFnGetAggregateMappingIDs, &GetAggregateMappingIDs_Params, nullptr);

	AggregateID = GetAggregateMappingIDs_Params.AggregateID;
	TargetAggregateID = GetAggregateMappingIDs_Params.TargetAggregateID;
...
bool ADebugCameraHUD::DisplayMaterials(float X, float DY, class UMeshComponent* MeshComp, float& Y)
{
	...
	DisplayMaterials_Params.X = X;
	DisplayMaterials_Params.DY = DY;
	DisplayMaterials_Params.MeshComp = MeshComp;
	DisplayMaterials_Params.Y = Y;

	this->ProcessEvent(uFnDisplayMaterials, &DisplayMaterials_Params, nullptr);

	Y = DisplayMaterials_Params.Y;
...
bool UDebugCameraInput::InputKey(int32_t ControllerId, const class FName& Key, uint8_t Event, float AmountDepressed, bool bGamepad)
{
	...
	InputKey_Params.ControllerId = ControllerId;
	memcpy_s(&InputKey_Params.Key, sizeof(InputKey_Params.Key), &Key, sizeof(Key));
	InputKey_Params.Event = Event;
	InputKey_Params.AmountDepressed = AmountDepressed;
...
bool UGameAICmd_Hover_MoveToGoal::MoveToGoal(class AGameAIController* AI, class AActor* InGoal, float InGoalDistance, float InHoverHeight)
{
	...
	MoveToGoal_Params.InGoalDistance = InGoalDistance;
	MoveToGoal_Params.InHoverHeight = InHoverHeight;
...
bool UGameAICmd_Hover_MoveToGoal_Mesh::HoverToPoint(class AGameAIController* AI, const struct FVector& InPoint, float InGoalDistance, float InHoverHeight)
{
	...
	HoverToPoint_Params.InGoalDistance = InGoalDistance;
	HoverToPoint_Params.InHoverHeight = InHoverHeight;
...
bool UGameAICmd_Hover_MoveToGoal_Mesh::HoverToGoal(class AGameAIController* AI, class AActor* InGoal, float InGoalDistance, float InHoverHeight)
{
	...
	HoverToGoal_Params.InGoalDistance = InGoalDistance;
	HoverToGoal_Params.InHoverHeight = InHoverHeight;
...
bool UMobileDebugCameraInput::InputKey(int32_t ControllerId, const class FName& Key, uint8_t Event, float AmountDepressed, bool bGamepad)
{
	static UFunction* uFnInputKey = nullptr;
...
void UMobileMenuBar::SetFirstItem(int32_t first)
{
	...
	SetFirstItem_Params.first = first;
...
void UMobileMenuBar::RenderItem(class UCanvas* Canvas, float DeltaTime, int32_t ItemIndex)
{
	...
	RenderItem_Params.DeltaTime = DeltaTime;
	RenderItem_Params.ItemIndex = ItemIndex;
...
bool UMobileMenuBar::eventOnTouch(uint8_t EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	static UFunction* uFnOnTouch = nullptr;
...
void UMobileMenuElement::RenderElement(class UMobileMenuObject* Owner, class UCanvas* Canvas, float DeltaTime, float Opacity)
{
	...
	RenderElement_Params.DeltaTime = DeltaTime;
	RenderElement_Params.Opacity = Opacity;
...
bool UMobileMenuElement::OnTouch(uint8_t EventType, float TouchX, float TouchY, float DeltaTime)
{
	static UFunction* uFnOnTouch = nullptr;
...
void UMobileMenuInventory::RenderDragItem(class UCanvas* Canvas, float DeltaTime)
{
	...
	RenderDragItem_Params.DeltaTime = DeltaTime;
...
int32_t UMobileMenuInventory::FindSlotIndexAt(float X, float Y)
{
	...
	FindSlotIndexAt_Params.X = X;
	FindSlotIndexAt_Params.Y = Y;
...
void UMobileMenuInventory::InitDragAt(int32_t TouchX, int32_t TouchY)
{
	...
	InitDragAt_Params.TouchX = TouchX;
	InitDragAt_Params.TouchY = TouchY;
...
void UMobileMenuInventory::UpdateItemInSlot(int32_t InSlot)
{
	...
	UpdateItemInSlot_Params.InSlot = InSlot;
...
class UMobileMenuElement* UMobileMenuInventory::AddItemToSlot(class UMobileMenuElement* Element, int32_t ToSlot)
{
	...
	AddItemToSlot_Params.ToSlot = ToSlot;
...
bool UMobileMenuInventory::SwapItemsInSlots(int32_t Slot0, int32_t Slot1)
{
	...
	SwapItemsInSlots_Params.Slot0 = Slot0;
	SwapItemsInSlots_Params.Slot1 = Slot1;
...
bool UMobileMenuInventory::eventOnTouch(uint8_t EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	static UFunction* uFnOnTouch = nullptr;
...
bool UMobileMenuInventory::CanPutItemInSlot(class UMobileMenuElement* Item, class UMobileMenuElement* ToSlot, int32_t ToIdx, int32_t FromIdx)
{
	...
	CanPutItemInSlot_Params.ToIdx = ToIdx;
	CanPutItemInSlot_Params.FromIdx = FromIdx;
...
bool UMobileMenuInventory::DoCanPutItemInSlot(class UMobileMenuInventory* FromInv, class UMobileMenuElement* Item, class UMobileMenuElement* ToSlot, int32_t ToIdx, int32_t FromIdx)
{
	...
	DoCanPutItemInSlot_Params.ToIdx = ToIdx;
	DoCanPutItemInSlot_Params.FromIdx = FromIdx;
...
void UMobileMenuInventory::OnUpdateItemInSlot(class UMobileMenuInventory* FromInv, int32_t SlotIndex)
{
	...
	OnUpdateItemInSlot_Params.SlotIndex = SlotIndex;
...
void UMobileMenuList::UpdateScroll(float DeltaTime)
{
	...
	UpdateScroll_Params.DeltaTime = DeltaTime;
...
float UMobileMenuList::CalculateSelectedItem(float ScrollAmount, bool bForceZeroAdjustment, struct FSelectedMenuItem& Selected)
{
	...
	CalculateSelectedItem_Params.ScrollAmount = ScrollAmount;
...
class UMobileMenuListItem* UMobileMenuList::GetItemClickPosition(float& MouseX, float& MouseY)
{
	...
	GetItemClickPosition_Params.MouseX = MouseX;
	GetItemClickPosition_Params.MouseY = MouseY;

	this->ProcessEvent(uFnGetItemClickPosition, &GetItemClickPosition_Params, nullptr);

	MouseX = GetItemClickPosition_Params.MouseX;
	MouseY = GetItemClickPosition_Params.MouseY;
...
bool UMobileMenuList::eventOnTouch(uint8_t EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	static UFunction* uFnOnTouch = nullptr;
...
bool UMobileMenuList::SetSelectedItem(int32_t ItemIndex, bool bForceAll)
{
	...
	SetSelectedItem_Params.ItemIndex = ItemIndex;
...
int32_t UMobileMenuList::SetSelectedToVisibleIndex(int32_t VisibleIndex)
{
	...
	SetSelectedToVisibleIndex_Params.VisibleIndex = VisibleIndex;
...
bool UMobileMenuObjectProxy::eventOnTouch(uint8_t EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	static UFunction* uFnOnTouch = nullptr;
...
void UMobileMenuObjectProxy::OnRenderObject(class UMobileMenuObjectProxy* Proxy, class UCanvas* Canvas, float DeltaTime)
{
	...
	OnRenderObject_Params.DeltaTime = DeltaTime;
...
bool UMobileMenuObjectProxy::OnTouchEvent(class UMobileMenuObjectProxy* Proxy, uint8_t EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	...
	OnTouchEvent_Params.EventType = EventType;
	OnTouchEvent_Params.TouchX = TouchX;
	OnTouchEvent_Params.TouchY = TouchY;
	OnTouchEvent_Params.ObjectOver = ObjectOver;
	OnTouchEvent_Params.DeltaTime = DeltaTime;
