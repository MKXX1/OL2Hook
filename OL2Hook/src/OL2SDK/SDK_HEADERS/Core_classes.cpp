...
std::string UObject::GetNameCPP()
{
	...
	if (this->IsA<UClass>())
	{
		...
		while (uClass)
		{
			...
			uClass = static_cast<UClass*>(uClass->SuperStruct);
		}
	}
	else
	{
...
class UClass* UObject::FindClass(const std::string& classFullName)
{
	...
	static int32_t cachedObjectCount = -1;
	...
	const int32_t objectCount = objects->size();
	if (objectCount != cachedObjectCount)
	{
		classCache.clear();

		// UE3 can fill holes below ArrayCount. Rebuild the snapshot whenever
		// the object array grows or is reset instead of scanning only its tail.
		for (int32_t i = 0; i < objectCount; ++i)
		{
			UObject* object = objects->at(i);
			if (object)
			{
				std::string objectFullName = object->GetFullName();
				if (objectFullName.starts_with("Class "))
				{
					classCache[std::move(objectFullName)] = static_cast<UClass*>(object);
				}
			}
		}
	...
	auto cachedClass = classCache.find(classFullName);
	if (cachedClass != classCache.end())
	{
		return cachedClass->second;
	}
...
{
	for (UClass* uSuperClass = static_cast<UClass*>(this->Class); uSuperClass; uSuperClass = static_cast<UClass*>(uSuperClass->SuperStruct))
	{
...
{
	UClass* uClass = static_cast<UClass*>(UObject::GObjObjects()->at(objInternalInteger));
...
void UObject::ProcessEvent(class UFunction* Function, void* Parms, void* Result)
{
	GetVirtualFunction<void(*)(class UObject*, class UFunction*, void*, void*)>(this, 68)(this, Function, Parms, Result);
}
...
void UObject::ProfNodeSetDepthThreshold(int32_t Depth)
{
	...
	ProfNodeSetDepthThreshold_Params.Depth = Depth;
...
void UObject::ProfNodeSetTimeThresholdSeconds(float Threshold)
{
	...
	ProfNodeSetTimeThresholdSeconds_Params.Threshold = Threshold;
...
void UObject::ProfNodeStop(int32_t AssumedTimerIndex)
{
	...
	ProfNodeStop_Params.AssumedTimerIndex = AssumedTimerIndex;
...
void UObject::GetSystemTime(int32_t& Year, int32_t& Month, int32_t& DayOfWeek, int32_t& Day, int32_t& Hour, int32_t& Min, int32_t& Sec, int32_t& MSec)
{
	...
	GetSystemTime_Params.Year = Year;
	GetSystemTime_Params.Month = Month;
	GetSystemTime_Params.DayOfWeek = DayOfWeek;
	GetSystemTime_Params.Day = Day;
	GetSystemTime_Params.Hour = Hour;
	GetSystemTime_Params.Min = Min;
	GetSystemTime_Params.Sec = Sec;
	GetSystemTime_Params.MSec = MSec;

	this->ProcessEvent(uFnGetSystemTime, &GetSystemTime_Params, nullptr);

	Year = GetSystemTime_Params.Year;
	Month = GetSystemTime_Params.Month;
	DayOfWeek = GetSystemTime_Params.DayOfWeek;
	Day = GetSystemTime_Params.Day;
	Hour = GetSystemTime_Params.Hour;
	Min = GetSystemTime_Params.Min;
	Sec = GetSystemTime_Params.Sec;
	MSec = GetSystemTime_Params.MSec;
}
...
float UObject::ByteToFloat(uint8_t inputByte, bool bSigned)
{
	...
	ByteToFloat_Params.inputByte = inputByte;
...
// [0x00426401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_OptionalParm | FUNC_Public | FUNC_HasOutParms | FUNC_AllFlags)
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
...
bool UObject::GetPerObjectConfigSections(class UClass* SearchClass, class UObject* ObjectOuter, int32_t MaxResults, class TArray<class FString>& out_SectionNames)
{
	...
	GetPerObjectConfigSections_Params.MaxResults = MaxResults;
...
// [0x00024401] (FUNC_Final | FUNC_Native | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags) (iNative[281])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FName                    TestState                      (CPF_Parm)
...
// [0x00024401] (FUNC_Final | FUNC_Native | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags) (iNative[113])
// Parameter Info:
...
void UObject::DebugBreak(int32_t UserFlags, uint8_t DebuggerType)
{
	...
	DebugBreak_Params.UserFlags = UserFlags;
	DebugBreak_Params.DebuggerType = DebuggerType;
...
// [0x00046401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_OptionalParm | FUNC_Private | FUNC_AllFlags) (iNative[231])
// Parameter Info:
// class FString                  S                              (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
struct FColor UObject::MakeColor(uint8_t R, uint8_t G, uint8_t B, uint8_t A)
{
	...
	MakeColor_Params.R = R;
	MakeColor_Params.G = G;
	MakeColor_Params.B = B;
	MakeColor_Params.A = A;
...
struct FVector2D UObject::DivideEqual_Vector2DFloat(float B, struct FVector2D& A)
{
	...
	DivideEqual_Vector2DFloat_Params.B = B;
...
struct FVector2D UObject::MultiplyEqual_Vector2DFloat(float B, struct FVector2D& A)
{
	...
	MultiplyEqual_Vector2DFloat_Params.B = B;
...
struct FVector2D UObject::Divide_Vector2DFloat(const struct FVector2D& A, float B)
{
	...
	Divide_Vector2DFloat_Params.B = B;
...
struct FVector2D UObject::Multiply_Vector2DFloat(const struct FVector2D& A, float B)
{
	...
	Multiply_Vector2DFloat_Params.B = B;
...
struct FVector UObject::MatrixGetAxis(const struct FMatrix& TM, uint8_t Axis)
{
	...
	MatrixGetAxis_Params.Axis = Axis;
...
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[119])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
...
bool UObject::NotEqual_ObjectObject(class UObject* A, class UObject* B)
{
	...
	uFnNotEqual_ObjectObject->iNative = 119;

	return NotEqual_ObjectObject_Params.ReturnValue;
}

// Function Core.Object.EqualEqual_ObjectObject
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[114])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class UObject*                 A                              (CPF_Parm)
// class UObject*                 B                              (CPF_Parm)
...
bool UObject::EqualEqual_ObjectObject(class UObject* A, class UObject* B)
{
	...
	uFnEqualEqual_ObjectObject->iNative = 114;
...
// [0x00026401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags) (iNative[201])
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
...
// [0x00026401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags) (iNative[127])
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// class FString                  S                              (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
// int32_t                        I                              (CPF_Parm)
...
// [0x00026401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags) (iNative[126])
// Parameter Info:
// int32_t                        ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  S                              (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[124])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
...
bool UObject::ComplementEqual_StrStr(const class FString& A, const class FString& B)
{
	...
	uFnComplementEqual_StrStr->iNative = 124;

	return ComplementEqual_StrStr_Params.ReturnValue;
}

// Function Core.Object.NotEqual_StrStr
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[123])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  A                              (CPF_Parm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_NeedCtorLink)
...
bool UObject::NotEqual_StrStr(const class FString& A, const class FString& B)
{
	...
	uFnNotEqual_StrStr->iNative = 123;

	return NotEqual_StrStr_Params.ReturnValue;
}

// Function Core.Object.EqualEqual_StrStr
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[122])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  A                              (CPF_Parm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_NeedCtorLink)
...
bool UObject::EqualEqual_StrStr(const class FString& A, const class FString& B)
{
	...
	uFnEqualEqual_StrStr->iNative = 122;

	return EqualEqual_StrStr_Params.ReturnValue;
}

// Function Core.Object.GreaterEqual_StrStr
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[121])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  A                              (CPF_Parm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_NeedCtorLink)
...
bool UObject::GreaterEqual_StrStr(const class FString& A, const class FString& B)
{
	...
	uFnGreaterEqual_StrStr->iNative = 121;

	return GreaterEqual_StrStr_Params.ReturnValue;
}

// Function Core.Object.LessEqual_StrStr
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[120])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  A                              (CPF_Parm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_NeedCtorLink)
...
bool UObject::LessEqual_StrStr(const class FString& A, const class FString& B)
{
	...
	uFnLessEqual_StrStr->iNative = 120;

	return LessEqual_StrStr_Params.ReturnValue;
}

// Function Core.Object.Greater_StrStr
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[116])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  A                              (CPF_Parm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_NeedCtorLink)
...
bool UObject::Greater_StrStr(const class FString& A, const class FString& B)
{
	...
	uFnGreater_StrStr->iNative = 116;

	return Greater_StrStr_Params.ReturnValue;
}

// Function Core.Object.Less_StrStr
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[115])
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// class FString                  A                              (CPF_Parm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_NeedCtorLink)
...
// [0x00023401] (FUNC_Final | FUNC_Native | FUNC_Operator | FUNC_Static | FUNC_Public | FUNC_AllFlags) (iNative[112])
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// class FString                  A                              (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
// class FString                  B                              (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
bool UObject::SClampRotAxis(float DeltaTime, int32_t ViewAxis, int32_t MaxLimit, int32_t MinLimit, float InterpolationSpeed, int32_t& out_DeltaViewAxis)
{
	...
	SClampRotAxis_Params.out_DeltaViewAxis = out_DeltaViewAxis;

	UObject::StaticClass()->ProcessEvent(uFnSClampRotAxis, &SClampRotAxis_Params, nullptr);

	out_DeltaViewAxis = SClampRotAxis_Params.out_DeltaViewAxis;
...
void UObject::ClampRotAxis(int32_t ViewAxis, int32_t MaxLimit, int32_t MinLimit, int32_t& out_DeltaViewAxis)
{
	...
	ClampRotAxis_Params.out_DeltaViewAxis = out_DeltaViewAxis;

	UObject::StaticClass()->ProcessEvent(uFnClampRotAxis, &ClampRotAxis_Params, nullptr);

	out_DeltaViewAxis = ClampRotAxis_Params.out_DeltaViewAxis;
}
...
// [0x00026401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags) (iNative[320])
// Parameter Info:
// struct FRotator                ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
...
struct FVector UObject::GetRotatorAxis(const struct FRotator& A, int32_t Axis)
{
	...
	GetRotatorAxis_Params.Axis = Axis;
...
float UObject::SubtractEqual_FloatFloat(float B, float& A)
{
	...
	SubtractEqual_FloatFloat_Params.A = A;
	...
	A = SubtractEqual_FloatFloat_Params.A;
...
float UObject::AddEqual_FloatFloat(float B, float& A)
{
	...
	AddEqual_FloatFloat_Params.A = A;
	...
	A = AddEqual_FloatFloat_Params.A;
...
float UObject::DivideEqual_FloatFloat(float B, float& A)
{
	...
	DivideEqual_FloatFloat_Params.A = A;
	...
	A = DivideEqual_FloatFloat_Params.A;
...
float UObject::MultiplyEqual_FloatFloat(float B, float& A)
{
	...
	MultiplyEqual_FloatFloat_Params.A = A;
	...
	A = MultiplyEqual_FloatFloat_Params.A;
...
int32_t UObject::SubtractSubtract_Int(int32_t& A)
{
	...
	SubtractSubtract_Int_Params.A = A;
	...
	A = SubtractSubtract_Int_Params.A;
...
int32_t UObject::SubtractSubtract_PreInt(int32_t& A)
{
	...
	SubtractSubtract_PreInt_Params.A = A;
	...
	A = SubtractSubtract_PreInt_Params.A;
...
int32_t UObject::SubtractEqual_IntInt(int32_t B, int32_t& A)
{
	...
	SubtractEqual_IntInt_Params.A = A;
	...
	A = SubtractEqual_IntInt_Params.A;
...
int32_t UObject::DivideEqual_IntFloat(float B, int32_t& A)
{
	...
	DivideEqual_IntFloat_Params.A = A;
	...
	A = DivideEqual_IntFloat_Params.A;
...
int32_t UObject::MultiplyEqual_IntFloat(float B, int32_t& A)
{
	...
	MultiplyEqual_IntFloat_Params.A = A;
	...
	A = MultiplyEqual_IntFloat_Params.A;
...
uint8_t UObject::SubtractSubtract_Byte(uint8_t& A)
{
	...
	SubtractSubtract_Byte_Params.A = A;
	...
	A = SubtractSubtract_Byte_Params.A;
...
uint8_t UObject::SubtractSubtract_PreByte(uint8_t& A)
{
	...
	SubtractSubtract_PreByte_Params.A = A;
	...
	A = SubtractSubtract_PreByte_Params.A;
...
uint8_t UObject::SubtractEqual_ByteByte(uint8_t B, uint8_t& A)
{
	...
	SubtractEqual_ByteByte_Params.B = B;
	SubtractEqual_ByteByte_Params.A = A;
	...
	A = SubtractEqual_ByteByte_Params.A;
...
uint8_t UObject::AddEqual_ByteByte(uint8_t B, uint8_t& A)
{
	...
	AddEqual_ByteByte_Params.B = B;
	AddEqual_ByteByte_Params.A = A;
...
uint8_t UObject::DivideEqual_ByteByte(uint8_t B, uint8_t& A)
{
	...
	DivideEqual_ByteByte_Params.B = B;
	DivideEqual_ByteByte_Params.A = A;
	...
	A = DivideEqual_ByteByte_Params.A;
...
uint8_t UObject::MultiplyEqual_ByteFloat(float B, uint8_t& A)
{
	...
	MultiplyEqual_ByteFloat_Params.A = A;
	...
	A = MultiplyEqual_ByteFloat_Params.A;
...
uint8_t UObject::MultiplyEqual_ByteByte(uint8_t B, uint8_t& A)
{
	...
	MultiplyEqual_ByteByte_Params.B = B;
	MultiplyEqual_ByteByte_Params.A = A;
	...
	A = MultiplyEqual_ByteByte_Params.A;
...
class UFunction* UFunction::FindFunction(const std::string& functionFullName)
{
	...
	if (objectCount != cachedObjectCount)
	{
		...
		for (int32_t i = 0; i < objectCount; ++i)
		{
			...
			{
				std::string objectFullName = object->GetFullName();
				if (objectFullName.starts_with("Function "))
				{
					functionCache[std::move(objectFullName)] = static_cast<UFunction*>(object);
				}
			}
		}
	...
	auto cachedFunction = functionCache.find(functionFullName);
...
struct FVector UDistributionVector::GetVectorValue(float F, int32_t LastExtreme)
{
	...
	GetVectorValue_Params.F = F;
	GetVectorValue_Params.LastExtreme = LastExtreme;
