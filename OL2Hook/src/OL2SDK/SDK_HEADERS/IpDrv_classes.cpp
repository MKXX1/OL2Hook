...
bool AInternetLink::ParseURL(const class FString& URL, class FString& Addr, int32_t& PortNum, class FString& LevelName, class FString& EntryName)
{
	...
	ParseURL_Params.PortNum = PortNum;
	...
	PortNum = ParseURL_Params.PortNum;
...
void ATcpLink::eventReceivedBinary(int32_t Count, uint8_t B[255])
{
	...
	ReceivedBinary_Params.Count = Count;
...
int32_t ATcpLink::BindPort(int32_t PortNum, bool bUseNextAvailable)
{
	...
	BindPort_Params.PortNum = PortNum;
...
class FString UOnlineNewsInterfaceMcp::GetNews(uint8_t LocalUserNum, uint8_t NewsType)
{
	...
	GetNews_Params.LocalUserNum = LocalUserNum;
	GetNews_Params.NewsType = NewsType;
...
void UOnlineNewsInterfaceMcp::OnReadNewsCompleted(bool bWasSuccessful, uint8_t NewsType)
{
	...
	OnReadNewsCompleted_Params.NewsType = NewsType;
...
bool UOnlineNewsInterfaceMcp::ReadNews(uint8_t LocalUserNum, uint8_t NewsType)
{
	...
	ReadNews_Params.LocalUserNum = LocalUserNum;
	ReadNews_Params.NewsType = NewsType;
...
uint8_t UOnlineTitleFileDownloadBase::GetTitleFileState(const class FString& Filename)
{
...
uint8_t UOnlineTitleFileDownloadMcp::GetTitleFileState(const class FString& Filename)
{
	static UFunction* uFnGetTitleFileState = nullptr;
...
uint8_t UOnlineTitleFileDownloadWeb::GetTitleFileState(const class FString& Filename)
{
	static UFunction* uFnGetTitleFileState = nullptr;
...
bool UOnlineTitleFileDownloadWeb::UncompressTitleFileContents(uint8_t FileCompressionType, class TArray<uint8_t>& CompressedFileContents, class TArray<uint8_t>& UncompressedFileContents)
{
	...
	UncompressTitleFileContents_Params.FileCompressionType = FileCompressionType;
...
uint8_t UTitleFileDownloadCache::GetTitleFileState(const class FString& Filename)
{
	static UFunction* uFnGetTitleFileState = nullptr;
...
bool UMcpMessageManager::StartAsyncUncompression(const class FString& MessageId, uint8_t MessageCompressionType, class TArray<uint8_t>& MessageContent)
{
	...
	StartAsyncUncompression_Params.MessageCompressionType = MessageCompressionType;
...
bool UMcpMessageManager::StartAsyncCompression(uint8_t MessageCompressionType, class UHttpRequestInterface* Request, class TArray<uint8_t>& MessageContent)
{
	...
	StartAsyncCompression_Params.MessageCompressionType = MessageCompressionType;
...
void UMcpUserCloudFileDownload::GetUserFileIndexForRequest(class UHttpRequestInterface* Request, int32_t& UserIdx, int32_t& FileIdx)
{
	...
	GetUserFileIndexForRequest_Params.UserIdx = UserIdx;
	GetUserFileIndexForRequest_Params.FileIdx = FileIdx;

	this->ProcessEvent(uFnGetUserFileIndexForRequest, &GetUserFileIndexForRequest_Params, nullptr);

	UserIdx = GetUserFileIndexForRequest_Params.UserIdx;
	FileIdx = GetUserFileIndexForRequest_Params.FileIdx;
}
...
void UMeshBeaconClient::OnReceivedBandwidthTestResults(uint8_t TestType, uint8_t TestResult, struct FConnectionBandwidthStats& BandwidthStats)
{
	...
	OnReceivedBandwidthTestResults_Params.TestType = TestType;
	OnReceivedBandwidthTestResults_Params.TestResult = TestResult;
...
void UMeshBeaconClient::OnReceivedBandwidthTestRequest(uint8_t TestType)
{
	...
	OnReceivedBandwidthTestRequest_Params.TestType = TestType;
...
void UMeshBeaconClient::OnConnectionRequestResult(uint8_t ConnectionResult)
{
	...
	OnConnectionRequestResult_Params.ConnectionResult = ConnectionResult;
...
bool UMeshBeaconClient::BeginBandwidthTest(uint8_t TestType, int32_t TestBufferSize)
{
	...
	BeginBandwidthTest_Params.TestType = TestType;
	BeginBandwidthTest_Params.TestBufferSize = TestBufferSize;
...
void UMeshBeaconHost::OnFinishedBandwidthTest(const struct FUniqueNetId& PlayerNetId, uint8_t TestType, uint8_t TestResult, struct FConnectionBandwidthStats& BandwidthStats)
{
	...
	OnFinishedBandwidthTest_Params.TestType = TestType;
	OnFinishedBandwidthTest_Params.TestResult = TestResult;
...
void UMeshBeaconHost::OnStartedBandwidthTest(const struct FUniqueNetId& PlayerNetId, uint8_t TestType)
{
	...
	OnStartedBandwidthTest_Params.TestType = TestType;
...
bool UMeshBeaconHost::RequestClientBandwidthTest(const struct FUniqueNetId& PlayerNetId, uint8_t TestType, int32_t TestBufferSize)
{
	...
	RequestClientBandwidthTest_Params.TestType = TestType;
	RequestClientBandwidthTest_Params.TestBufferSize = TestBufferSize;
...
bool UOnlineAuthInterfaceImpl::GetServerAddr(struct FIpAddr& OutServerIP, int32_t& OutServerPort)
{
	...
	GetServerAddr_Params.OutServerPort = OutServerPort;
	...
	OutServerPort = GetServerAddr_Params.OutServerPort;
...
bool UOnlineAuthInterfaceImpl::CreateServerAuthSession(const struct FUniqueNetId& ClientUID, const struct FIpAddr& ClientIP, int32_t ClientPort, int32_t& OutAuthTicketUID)
{
	...
	CreateServerAuthSession_Params.OutAuthTicketUID = OutAuthTicketUID;

	this->ProcessEvent(uFnCreateServerAuthSession, &CreateServerAuthSession_Params, nullptr);

	OutAuthTicketUID = CreateServerAuthSession_Params.OutAuthTicketUID;
...
bool UOnlineAuthInterfaceImpl::CreateClientAuthSession(const struct FUniqueNetId& ServerUID, const struct FIpAddr& ServerIP, int32_t ServerPort, bool bSecure, int32_t& OutAuthTicketUID)
{
	...
	CreateClientAuthSession_Params.OutAuthTicketUID = OutAuthTicketUID;

	this->ProcessEvent(uFnCreateClientAuthSession, &CreateClientAuthSession_Params, nullptr);

	OutAuthTicketUID = CreateClientAuthSession_Params.OutAuthTicketUID;
...
// [0x00120000] (FUNC_Public | FUNC_Delegate | FUNC_AllFlags)
// Parameter Info:
// class TArray<struct FSessionMemberInfo> SesionMemberInfo               (CPF_Parm | CPF_NeedCtorLink)
// uint32_t                       bWasSuccessful                 (CPF_Parm)

void UOnlineGameInterfaceImpl::OnGetSessionMemberInfoComplete(const class TArray<struct FSessionMemberInfo>& SesionMemberInfo, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::GetCurrentSessionMemberInfo(uint8_t LocalUserNum, const class FName& SessionName)
{
	...
	GetCurrentSessionMemberInfo_Params.LocalUserNum = LocalUserNum;
...
void UOnlineGameInterfaceImpl::ClearPokeInactivePlayersCompleteDelegate(const struct FScriptDelegate& PokeInactivePlayersCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddPokeInactivePlayersCompleteDelegate(const struct FScriptDelegate& PokeInactivePlayersCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnPokeInactivePlayersComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::PokeInactivePlayers(uint8_t PlayerNum, const class FName& SessionName)
{
	...
	PokeInactivePlayers_Params.PlayerNum = PlayerNum;
...
void UOnlineGameInterfaceImpl::ClearPullReservedPlayersIntoSessionCompleteDelegate(const struct FScriptDelegate& PullReservedPlayersIntoSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddPullReservedPlayersIntoSessionCompleteDelegate(const struct FScriptDelegate& PullReservedPlayersIntoSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnPullReservedPlayersIntoSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::PullReservedPlayersIntoSession(uint8_t PlayerNum, const class FName& SessionName)
{
	...
	PullReservedPlayersIntoSession_Params.PlayerNum = PlayerNum;
...
void UOnlineGameInterfaceImpl::ClearGetAvailablePlayersFromPartyCompleteDelegate(const struct FScriptDelegate& GetAvailablePlayersFromPartyCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddGetAvailablePlayersFromPartyCompleteDelegate(const struct FScriptDelegate& GetAvailablePlayersFromPartyCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnGetAvailablePlayersFromPartyComplete(const class TArray<struct FUniqueNetId>& Players, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::GetAvailablePlayersFromParty(uint8_t PlayerNum)
{
	...
	GetAvailablePlayersFromParty_Params.PlayerNum = PlayerNum;
...
bool UOnlineGameInterfaceImpl::BindPlatformSpecificSessionToSearch(uint8_t SearchingPlayerNum, class UOnlineGameSearch* SearchSettings, uint8_t PlatformSpecificInfo[80])
{
	...
	BindPlatformSpecificSessionToSearch_Params.SearchingPlayerNum = SearchingPlayerNum;
...
bool UOnlineGameInterfaceImpl::JoinMigratedOnlineGame(uint8_t PlayerNum, const class FName& SessionName, struct FOnlineGameSearchResult& DesiredGame)
{
	...
	JoinMigratedOnlineGame_Params.PlayerNum = PlayerNum;
...
bool UOnlineGameInterfaceImpl::MigrateOnlineGame(uint8_t HostingPlayerNum, const class FName& SessionName)
{
	...
	MigrateOnlineGame_Params.HostingPlayerNum = HostingPlayerNum;
...
bool UOnlineGameInterfaceImpl::AcceptGameInvite(uint8_t LocalUserNum, const class FName& SessionName)
{
	...
	AcceptGameInvite_Params.LocalUserNum = LocalUserNum;
...
void UOnlineGameInterfaceImpl::ClearGameInviteAcceptedDelegate(uint8_t LocalUserNum, const struct FScriptDelegate& GameInviteAcceptedDelegate)
{
	...
	ClearGameInviteAcceptedDelegate_Params.LocalUserNum = LocalUserNum;
...
void UOnlineGameInterfaceImpl::AddGameInviteAcceptedDelegate(uint8_t LocalUserNum, const struct FScriptDelegate& GameInviteAcceptedDelegate)
{
	...
	AddGameInviteAcceptedDelegate_Params.LocalUserNum = LocalUserNum;
...
void UOnlineGameInterfaceImpl::ClearJoinOnlineSessionCompleteDelegate(const struct FScriptDelegate& JoinOnlineSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddJoinOnlineSessionCompleteDelegate(const struct FScriptDelegate& JoinOnlineSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnJoinOnlineSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::JoinOnlineSession(uint8_t LocalPlayerNum, const class FName& SessionName)
{
	...
	JoinOnlineSession_Params.LocalPlayerNum = LocalPlayerNum;
...
void UOnlineGameInterfaceImpl::OnQuerySessionsForUserComplete(uint8_t LocalPlayerNum, bool bWasSuccessful)
{
	...
	OnQuerySessionsForUserComplete_Params.LocalPlayerNum = LocalPlayerNum;
...
bool UOnlineGameInterfaceImpl::QuerySessionsForUser(uint8_t LocalPlayerNum)
{
	...
	QuerySessionsForUser_Params.LocalPlayerNum = LocalPlayerNum;
...
// Parameter Info:
// uint32_t                       bClearSessionIfHost            (CPF_OptionalParm | CPF_Parm)
...
void UOnlineGameInterfaceImpl::ClearLeaveOnlineSessionCompleteDelegate(const struct FScriptDelegate& LeaveOnlineSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddLeaveOnlineSessionCompleteDelegate(const struct FScriptDelegate& LeaveOnlineSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnLeaveOnlineSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::LeaveOnlineSession(uint8_t LocalPlayerNum, const class FName& SessionName, bool bClearSessionIfHost)
{
	...
	LeaveOnlineSession_Params.LocalPlayerNum = LocalPlayerNum;
...
void UOnlineGameInterfaceImpl::OnMatchStatusChanged(const class FName& SessionName, uint8_t Status)
{
	...
	OnMatchStatusChanged_Params.Status = Status;
...
void UOnlineGameInterfaceImpl::OnAcceptPendingGameSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
void UOnlineGameInterfaceImpl::AcceptPendingGameSession(const class FName& SessionName)
{
...
void UOnlineGameInterfaceImpl::OnGameSessionReady(const class FName& SessionName)
{
...
void UOnlineGameInterfaceImpl::OnUpdateSessionPropertiesComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::UpdateSessionProperties(uint8_t ScoutingUserNum, const class FName& SessionName)
{
	...
	UpdateSessionProperties_Params.ScoutingUserNum = ScoutingUserNum;
...
bool UOnlineGameInterfaceImpl::DeleteCustomMemberProperty(const class FName& SessionName, const class FString& PropertyName)
{
...
bool UOnlineGameInterfaceImpl::SetCustomMemberProperty(const class FName& SessionName, const class FString& PropertyName, const class FString& PropertyValue)
{
...
bool UOnlineGameInterfaceImpl::DeleteCustomSessionProperty(const class FName& SessionName, const class FString& PropertyName)
{
...
bool UOnlineGameInterfaceImpl::SetCustomSessionProperty(const class FName& SessionName, const class FString& PropertyName, const class FString& PropertyValue)
{
...
void UOnlineGameInterfaceImpl::ClearDeleteMatchTicketCompleteDelegate(const struct FScriptDelegate& DeleteMatchTicketCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddDeleteMatchTicketCompleteDelegate(const struct FScriptDelegate& DeleteMatchTicketCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnDeleteMatchTicketComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::DeleteMatchTicketWithHopper(uint8_t ScoutingPlayerNum, const class FName& SessionName, const class FString& HopperName)
{
	...
	DeleteMatchTicketWithHopper_Params.ScoutingPlayerNum = ScoutingPlayerNum;
...
bool UOnlineGameInterfaceImpl::DeleteMatchTicket(uint8_t ScoutingPlayerNum, const class FName& SessionName)
{
	...
	DeleteMatchTicket_Params.ScoutingPlayerNum = ScoutingPlayerNum;
...
void UOnlineGameInterfaceImpl::ClearQueryMatchmakingForSessionCompleteDelegate(const struct FScriptDelegate& QueryMatchmakingForSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddQueryMatchmakingForSessionCompleteDelegate(const struct FScriptDelegate& QueryMatchmakingForSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnQueryMatchmakingForSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
// class FString                  HopperName                     (CPF_Parm | CPF_NeedCtorLink)
// uint8_t                        CreateGameSessionType          (CPF_OptionalParm | CPF_Parm)

bool UOnlineGameInterfaceImpl::QueryMatchmakingForSessionWithHopper(uint8_t ScoutingPlayerNum, const class FName& SessionName, int32_t MatchTimeout, const class FString& HopperName, uint8_t CreateGameSessionType)
{
	...
	QueryMatchmakingForSessionWithHopper_Params.ScoutingPlayerNum = ScoutingPlayerNum;
	...
	QueryMatchmakingForSessionWithHopper_Params.MatchTimeout = MatchTimeout;
	...
	QueryMatchmakingForSessionWithHopper_Params.CreateGameSessionType = CreateGameSessionType;
...
bool UOnlineGameInterfaceImpl::QueryMatchmakingForSession(uint8_t ScoutingPlayerNum, const class FName& SessionName, int32_t MatchTimeout, uint8_t CreateGameSessionType)
{
	...
	QueryMatchmakingForSession_Params.ScoutingPlayerNum = ScoutingPlayerNum;
	...
	QueryMatchmakingForSession_Params.MatchTimeout = MatchTimeout;
	QueryMatchmakingForSession_Params.CreateGameSessionType = CreateGameSessionType;
...
void UOnlineGameInterfaceImpl::ClearRegisterGameSessionCompleteDelegate(const struct FScriptDelegate& RegisterGameSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddRegisterGameSessionCompleteDelegate(const struct FScriptDelegate& RegisterGameSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnRegisterGameSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::RegisterGameSession(uint8_t ScoutingPlayerNum, const class FName& SessionName)
{
	...
	RegisterGameSession_Params.ScoutingPlayerNum = ScoutingPlayerNum;
...
void UOnlineGameInterfaceImpl::OnAddSessionMemberComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
// uint8_t                        ScoutingPlayerNum              (CPF_Parm)
// class FName                    SessionName                    (CPF_Parm)
// class TArray<struct FUniqueNetId> Members                        (CPF_Parm | CPF_NeedCtorLink)

bool UOnlineGameInterfaceImpl::AddSessionMembers(uint8_t ScoutingPlayerNum, const class FName& SessionName, const class TArray<struct FUniqueNetId>& Members)
{
	...
	AddSessionMembers_Params.ScoutingPlayerNum = ScoutingPlayerNum;
...
bool UOnlineGameInterfaceImpl::AddSessionMember(uint8_t ScoutingPlayerNum, const class FName& SessionName, const struct FUniqueNetId& Member)
{
	...
	AddSessionMember_Params.ScoutingPlayerNum = ScoutingPlayerNum;
...
bool UOnlineGameInterfaceImpl::AddSessionMemberByString(uint8_t ScoutingPlayerNum, const class FName& SessionName, const class FString& Member)
{
	...
	AddSessionMemberByString_Params.ScoutingPlayerNum = ScoutingPlayerNum;
...
void UOnlineGameInterfaceImpl::ClearCreateOnlineSessionCompleteDelegate(const struct FScriptDelegate& CreateOnlineSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::AddCreateOnlineSessionCompleteDelegate(const struct FScriptDelegate& CreateOnlineSessionCompleteDelegate)
{
...
void UOnlineGameInterfaceImpl::OnCreateOnlineSessionComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::CreateOnlineSessionWithTemplate(uint8_t ScoutingPlayerNum, const class FName& SessionName, class UOnlineGameSettings* NewGameSettings, const class FString& TemplateName)
{
	...
	CreateOnlineSessionWithTemplate_Params.ScoutingPlayerNum = ScoutingPlayerNum;
	...
	CreateOnlineSessionWithTemplate_Params.NewGameSettings = NewGameSettings;
...
bool UOnlineGameInterfaceImpl::CreateOnlineSession(uint8_t ScoutingPlayerNum, const class FName& SessionName, class UOnlineGameSettings* NewGameSettings)
{
	...
	CreateOnlineSession_Params.ScoutingPlayerNum = ScoutingPlayerNum;
	...
	CreateOnlineSession_Params.NewGameSettings = NewGameSettings;
...
bool UOnlineGameInterfaceImpl::InitiatedSessionSearch(const class FName& SessionName)
{
...
bool UOnlineGameInterfaceImpl::IsHostOfSession(const class FName& SessionName)
{
...
void UOnlineGameInterfaceImpl::OnMatchmakeOnlineGameWithPartyComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::MatchmakeOnlineGameWithParty(uint8_t ScoutingPlayerNum, const class FName& SessionName, class UOnlineGameSettings* NewGameSettings)
{
	...
	MatchmakeOnlineGameWithParty_Params.ScoutingPlayerNum = ScoutingPlayerNum;
	...
	MatchmakeOnlineGameWithParty_Params.NewGameSettings = NewGameSettings;
...
void UOnlineGameInterfaceImpl::OnCreateOnlineGameWithPartyComplete(const class FName& SessionName, bool bWasSuccessful)
{
...
bool UOnlineGameInterfaceImpl::CreateOnlineGameWithParty(uint8_t ScoutingPlayerNum, const class FName& SessionName, class UOnlineGameSettings* NewGameSettings)
{
	...
	CreateOnlineGameWithParty_Params.ScoutingPlayerNum = ScoutingPlayerNum;
	...
	CreateOnlineGameWithParty_Params.NewGameSettings = NewGameSettings;
...
bool UOnlineGameInterfaceImpl::JoinOnlineGame(uint8_t PlayerNum, const class FName& SessionName, struct FOnlineGameSearchResult& DesiredGame)
{
	...
	JoinOnlineGame_Params.PlayerNum = PlayerNum;
...
bool UOnlineGameInterfaceImpl::FindOnlineGames(uint8_t SearchingPlayerNum, class UOnlineGameSearch* SearchSettings)
{
	...
	FindOnlineGames_Params.SearchingPlayerNum = SearchingPlayerNum;
...
bool UOnlineGameInterfaceImpl::CreateOnlineGame(uint8_t HostingPlayerNum, const class FName& SessionName, class UOnlineGameSettings* NewGameSettings)
{
	...
	CreateOnlineGame_Params.HostingPlayerNum = HostingPlayerNum;
...
void UOnlinePlaylistManager::eventSendPlaylistPopulationUpdate(int32_t NumPlayers)
{
	...
	SendPlaylistPopulationUpdate_Params.NumPlayers = NumPlayers;
...
void UOnlinePlaylistManager::GetPopulationInfoFromPlaylist(int32_t PlaylistId, int32_t& WorldwideTotal, int32_t& RegionTotal)
{
	...
	GetPopulationInfoFromPlaylist_Params.PlaylistId = PlaylistId;
	GetPopulationInfoFromPlaylist_Params.WorldwideTotal = WorldwideTotal;
	GetPopulationInfoFromPlaylist_Params.RegionTotal = RegionTotal;

	this->ProcessEvent(uFnGetPopulationInfoFromPlaylist, &GetPopulationInfoFromPlaylist_Params, nullptr);

	WorldwideTotal = GetPopulationInfoFromPlaylist_Params.WorldwideTotal;
	RegionTotal = GetPopulationInfoFromPlaylist_Params.RegionTotal;
}
...
void UOnlinePlaylistManager::GetContentIdsFromPlaylist(int32_t PlaylistId, class TArray<int32_t>& ContentIds)
{
	...
	GetContentIdsFromPlaylist_Params.PlaylistId = PlaylistId;
...
class UClass* UOnlinePlaylistManager::GetInventorySwapFromPlaylist(int32_t PlaylistId, class UClass* SourceInventory)
{
	...
	GetInventorySwapFromPlaylist_Params.PlaylistId = PlaylistId;
...
void UOnlinePlaylistManager::GetMapCycleFromPlaylist(int32_t PlaylistId, class TArray<class FName>& MapCycle)
{
	...
	GetMapCycleFromPlaylist_Params.PlaylistId = PlaylistId;
...
class FString UOnlinePlaylistManager::GetUrlFromPlaylist(int32_t PlaylistId)
{
	...
	GetUrlFromPlaylist_Params.PlaylistId = PlaylistId;
...
int32_t UOnlinePlaylistManager::GetMatchType(int32_t PlaylistId)
{
	...
	GetMatchType_Params.PlaylistId = PlaylistId;
...
bool UOnlinePlaylistManager::IsPlaylistArbitrated(int32_t PlaylistId)
{
	...
	IsPlaylistArbitrated_Params.PlaylistId = PlaylistId;
...
void UOnlinePlaylistManager::GetLoadBalanceIdFromPlaylist(int32_t PlaylistId, int32_t& LoadBalanceId)
{
	...
	GetLoadBalanceIdFromPlaylist_Params.PlaylistId = PlaylistId;
	GetLoadBalanceIdFromPlaylist_Params.LoadBalanceId = LoadBalanceId;

	this->ProcessEvent(uFnGetLoadBalanceIdFromPlaylist, &GetLoadBalanceIdFromPlaylist_Params, nullptr);

	LoadBalanceId = GetLoadBalanceIdFromPlaylist_Params.LoadBalanceId;
}
...
void UOnlinePlaylistManager::GetTeamInfoFromPlaylist(int32_t PlaylistId, int32_t& TeamSize, int32_t& TeamCount, int32_t& MaxPartySize)
{
	...
	GetTeamInfoFromPlaylist_Params.PlaylistId = PlaylistId;
	GetTeamInfoFromPlaylist_Params.TeamSize = TeamSize;
	GetTeamInfoFromPlaylist_Params.TeamCount = TeamCount;
	GetTeamInfoFromPlaylist_Params.MaxPartySize = MaxPartySize;

	this->ProcessEvent(uFnGetTeamInfoFromPlaylist, &GetTeamInfoFromPlaylist_Params, nullptr);

	TeamSize = GetTeamInfoFromPlaylist_Params.TeamSize;
	TeamCount = GetTeamInfoFromPlaylist_Params.TeamCount;
	MaxPartySize = GetTeamInfoFromPlaylist_Params.MaxPartySize;
}
...
bool UOnlinePlaylistManager::PlaylistSupportsDedicatedServers(int32_t PlaylistId)
{
	...
	PlaylistSupportsDedicatedServers_Params.PlaylistId = PlaylistId;
...
bool UOnlinePlaylistManager::HasAnyGameSettings(int32_t PlaylistId)
{
	...
	HasAnyGameSettings_Params.PlaylistId = PlaylistId;
...
class UOnlineGameSettings* UOnlinePlaylistManager::GetGameSettings(int32_t PlaylistId, int32_t GameSettingsId)
{
	...
	memset(&GetGameSettings_Params, 0, sizeof(GetGameSettings_Params));
	GetGameSettings_Params.PlaylistId = PlaylistId;
	GetGameSettings_Params.GameSettingsId = GameSettingsId;
...
void UPartyBeaconClient::OnReservationCountUpdated(int32_t ReservationRemaining)
{
	...
	OnReservationCountUpdated_Params.ReservationRemaining = ReservationRemaining;
...
void UPartyBeaconClient::OnReservationRequestComplete(uint8_t ReservationResult)
{
	...
	OnReservationRequestComplete_Params.ReservationResult = ReservationResult;
...
uint8_t UPartyBeaconHost::UpdatePartyReservationEntry(const struct FUniqueNetId& PartyLeader, class TArray<struct FPlayerReservation>& PlayerMembers)
{
...
uint8_t UPartyBeaconHost::AddPartyReservationEntry(const struct FUniqueNetId& PartyLeader, int32_t TeamNum, bool bIsHost, class TArray<struct FPlayerReservation>& PlayerMembers)
{
	...
	AddPartyReservationEntry_Params.TeamNum = TeamNum;
...
bool UPartyBeaconHost::InitHostBeacon(int32_t InNumTeams, int32_t InNumPlayersPerTeam, int32_t InNumReservations, const class FName& InSessionName, int32_t InForceTeamNum)
{
	...
	memset(&InitHostBeacon_Params, 0, sizeof(InitHostBeacon_Params));
	InitHostBeacon_Params.InNumTeams = InNumTeams;
	InitHostBeacon_Params.InNumPlayersPerTeam = InNumPlayersPerTeam;
	InitHostBeacon_Params.InNumReservations = InNumReservations;
	...
	InitHostBeacon_Params.InForceTeamNum = InForceTeamNum;
...
class FString UWebRequest::GetVariableNumber(const class FString& VariableName, int32_t Number, const class FString& DefaultValue)
{
	...
	GetVariableNumber_Params.Number = Number;
...
void UWebResponse::HTTPError(int32_t ErrorNum, const class FString& Data)
{
	...
	HTTPError_Params.ErrorNum = ErrorNum;
...
class FString UWebResponse::GetHTTPExpiration(int32_t OffsetSeconds)
{
	...
	GetHTTPExpiration_Params.OffsetSeconds = OffsetSeconds;
...
int32_t UUIDataStore_OnlinePlaylists::eventGetMatchTypeForPlaylistId(int32_t PlaylistId)
{
	...
	GetMatchTypeForPlaylistId_Params.PlaylistId = PlaylistId;
...
// [0x00426002] (FUNC_Defined | FUNC_Static | FUNC_OptionalParm | FUNC_Public | FUNC_HasOutParms | FUNC_AllFlags)
// Parameter Info:
...
class UOnlinePlaylistProvider* UUIDataStore_OnlinePlaylists::GetOnlinePlaylistProvider(const class FName& ProviderTag, int32_t PlaylistId, int32_t& ProviderIndex)
{
	...
	GetOnlinePlaylistProvider_Params.PlaylistId = PlaylistId;
	GetOnlinePlaylistProvider_Params.ProviderIndex = ProviderIndex;
	...
	ProviderIndex = GetOnlinePlaylistProvider_Params.ProviderIndex;
...
bool UUIDataStore_OnlinePlaylists::GetPlaylistProvider(const class FName& ProviderTag, int32_t ProviderIndex, class UUIResourceDataProvider*& out_Provider)
{
	...
	GetPlaylistProvider_Params.ProviderIndex = ProviderIndex;
...
void UMcpClashMobBase::UpdateChallengeUserReward(const class FString& UniqueChallengeId, const class FString& UniqueUserId, int32_t UserReward)
{
	...
	UpdateChallengeUserReward_Params.UserReward = UserReward;
...
void UMcpClashMobBase::UpdateChallengeUserProgress(const class FString& UniqueChallengeId, const class FString& UniqueUserId, bool bDidComplete, int32_t GoalProgress)
{
	...
	UpdateChallengeUserProgress_Params.GoalProgress = GoalProgress;
...
void UMcpGroupsManager::CacheGroupMember(const class FString& MemberId, const class FString& GroupID, uint8_t AcceptState)
{
	...
	CacheGroupMember_Params.AcceptState = AcceptState;
...
void UMcpManagedValueManagerBase::OnUpdateValueComplete(const class FString& McpId, const class FString& SaveSlot, const class FName& ValueId, int32_t Value, bool bWasSuccessful, const class FString& Error)
{
	...
	OnUpdateValueComplete_Params.Value = Value;
...
void UMcpManagedValueManagerBase::UpdateValue(const class FString& McpId, const class FString& SaveSlot, const class FName& ValueId, int32_t Value)
{
	...
	UpdateValue_Params.Value = Value;
...
void UMcpUserInventoryBase::DeleteItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& InstanceItemId, int32_t StoreVersion)
{
	...
	DeleteItem_Params.StoreVersion = StoreVersion;
...
void UMcpUserInventoryBase::ConsumeItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& InstanceItemId, int32_t Quantity, int32_t StoreVersion)
{
	...
	ConsumeItem_Params.Quantity = Quantity;
	ConsumeItem_Params.StoreVersion = StoreVersion;
...
void UMcpUserInventoryBase::EarnItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& GlobalItemId, int32_t Quantity, int32_t StoreVersion)
{
	...
	EarnItem_Params.Quantity = Quantity;
	EarnItem_Params.StoreVersion = StoreVersion;
...
void UMcpUserInventoryBase::SellItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& InstanceItemId, int32_t Quantity, int32_t StoreVersion, class TArray<struct FMcpInventoryItemContainer>& ExpectedResultItems)
{
	...
	SellItem_Params.Quantity = Quantity;
	SellItem_Params.StoreVersion = StoreVersion;
...
void UMcpUserInventoryBase::PurchaseItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& GlobalItemId, const class TArray<class FString>& PurchaseItemIds, int32_t Quantity, int32_t StoreVersion, float Scalar)
{
	...
	PurchaseItem_Params.Quantity = Quantity;
	PurchaseItem_Params.StoreVersion = StoreVersion;
	PurchaseItem_Params.Scalar = Scalar;
...
// [0x00424002] (FUNC_Defined | FUNC_OptionalParm | FUNC_Public | FUNC_HasOutParms | FUNC_AllFlags)
// Parameter Info:
// class FString                  McpId                          (CPF_Parm | CPF_NeedCtorLink)
// class FString                  SaveSlotId                     (CPF_Parm | CPF_NeedCtorLink)
// class FString                  InstanceItemId                 (CPF_Parm | CPF_NeedCtorLink)
