...
struct FAgentArchetypeInfo
{
	...
	class TArray<class UObject*>                       GroupMembers;                                  // 0x0014 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
};
...
struct FCrowdSpawnInfoItem
{
	...
	class TArray<class AGameCrowdAgent*>               ActiveAgents;                                  // 0x0018 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class TArray<struct FAgentArchetypeInfo>           AgentArchetypes;                               // 0x0028 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	class TArray<class AGameCrowdDestination*>         PotentialSpawnPoints;                          // 0x0060 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	class TArray<class AGameCrowdDestination*>         PrioritizedSpawnPoints;                        // 0x007C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct FRequiredMobileInputConfig
{
	...
	class TArray<class FString>                        RequireZoneNames;                              // 0x0010 (0x0010) [0x0000000000504000] (CPF_Config | CPF_NeedCtorLink)
...
struct FGameCrowdAttachmentList
{
	...
	class TArray<struct FGameCrowdAttachmentInfo>      List;                                          // 0x0008 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
};
...
struct FTeamState
{
	...
	class TArray<int32_t>                              PlayerIndices;                                 // 0x0004 (0x0010) [0x0000000000500000] (CPF_NeedCtorLink)
};
...
struct FEventsBase
{
	...
	class TArray<struct FGameEvents>                   EventsByClass;                                 // 0x0048 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FGameEvent
{
	class TArray<float>                                EventCountByTimePeriod;                        // 0x0000 (0x0010) [0x0000000000500000] (CPF_NeedCtorLink)
};
...
struct FCamFocusPointParams
{
	...
	class FName                                        FocusBoneName;                                 // 0x0008 (0x0008) [0x0000000000000001] (CPF_Edit)    
...
struct FTouchData
{
	...
	class TArray<struct FTouchDataEvent>               Events;                                        // 0x003C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct FMobileInputGroup
{
	...
	class TArray<class UMobileInputZone*>              AssociatedZones;                               // 0x0010 (0x0010) [0x0000000004400000] (CPF_NeedCtorLink | CPF_EditInline)
};
...
struct FDragElementInfo
{
	...
	uint8_t                                            MinStructAlignment[0x3];                         // 0x0025 (0x0003) ADDED PADDING
};
...
struct FMenuListDragInfo
{
	...
	struct FDragHistoryData                            UpdateHistory[4];                              // 0x002C (0x0020) [0x0000000000000000]               
