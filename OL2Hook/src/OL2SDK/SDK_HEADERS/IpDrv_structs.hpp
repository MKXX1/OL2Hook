...
struct FMcpClashMobChallengeFile
{
	...
	uint8_t                                            MinStructAlignment[0x3];                         // 0x0055 (0x0003) ADDED PADDING
};
...
struct FMcpGroup
{
	...
	class TArray<struct FMcpGroupMember>               Members;                                       // 0x0034 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FMcpInventoryItem
{
	...
	class TArray<struct FMcpInventoryItemAttribute>    Attributes;                                    // 0x003C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FClientConnectionRequest
{
	...
	class TArray<struct FConnectionBandwidthStats>     BandwidthHistory;                              // 0x001C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct FClientMeshBeaconConnection
{
	...
	class TArray<struct FConnectionBandwidthStats>     BandwidthHistory;                              // 0x0054 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct FPlaylist
{
	...
	class TArray<class FName>                          MapCycle;                                      // 0x006C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class TArray<struct FInventorySwap>                InventorySwaps;                                // 0x007C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FPartyReservation
{
	...
	class TArray<struct FPlayerReservation>            PartyMembers;                                  // 0x0014 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
