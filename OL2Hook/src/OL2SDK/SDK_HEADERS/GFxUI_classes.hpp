...
{
	EFlashTextureRescale_FlashTextureScale_High        = 0,
	EFlashTextureRescale_FlashTextureScale_Low         = 1,
	EFlashTextureRescale_FlashTextureScale_NextLow     = 2,
	EFlashTextureRescale_FlashTextureScale_Mult4       = 3,
	EFlashTextureRescale_FlashTextureScale_None        = 4,
	EFlashTextureRescale_FlashTextureScale_END         = 5
};

// Enum GFxUI.GFxMoviePlayer.ASType
enum EASType
{
	EASType_AS_Undefined                               = 0,
	EASType_AS_Null                                    = 1,
	EASType_AS_Number                                  = 2,
	EASType_AS_Int                                     = 3,
	EASType_AS_String                                  = 4,
	EASType_AS_Boolean                                 = 5,
	EASType_AS_END                                     = 6
};
...
enum EGFxAlign
{
	EGFxAlign_Align_Center                             = 0,
	EGFxAlign_Align_TopCenter                          = 1,
	EGFxAlign_Align_BottomCenter                       = 2,
	EGFxAlign_Align_CenterLeft                         = 3,
	EGFxAlign_Align_CenterRight                        = 4,
	EGFxAlign_Align_TopLeft                            = 5,
	EGFxAlign_Align_TopRight                           = 6,
	EGFxAlign_Align_BottomLeft                         = 7,
	EGFxAlign_Align_BottomRight                        = 8,
	EGFxAlign_Align_END                                = 9
};

// Enum GFxUI.GFxMoviePlayer.GFxScaleMode
enum EGFxScaleMode
{
	EGFxScaleMode_SM_NoScale                           = 0,
	EGFxScaleMode_SM_ShowAll                           = 1,
	EGFxScaleMode_SM_ExactFit                          = 2,
	EGFxScaleMode_SM_NoBorder                          = 3,
	EGFxScaleMode_SM_END                               = 4
};

// Enum GFxUI.GFxMoviePlayer.GFxTimingMode
enum EGFxTimingMode
{
	EGFxTimingMode_TM_Game                             = 0,
	EGFxTimingMode_TM_Real                             = 1,
	EGFxTimingMode_TM_END                              = 2
};

// Enum GFxUI.GFxMoviePlayer.GFxRenderTextureMode
enum EGFxRenderTextureMode
{
	EGFxRenderTextureMode_RTM_Opaque                   = 0,
	EGFxRenderTextureMode_RTM_Alpha                    = 1,
	EGFxRenderTextureMode_RTM_AlphaComposite           = 2,
	EGFxRenderTextureMode_RTM_END                      = 3
};
...
{
public:
	class TArray<struct FGCReference>                  GCReferences;                                  // 0x0068 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	uint8_t                                            UnknownData00[0x90];                            // 0x0080 (0x0090) MISSED OFFSET
	...
	class TArray<class FName>                          CaptureKeys;                                   // 0x0134 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class TArray<class FName>                          FocusIgnoreKeys;                               // 0x0144 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class TArray<struct FExternalTexture>              ExternalTextures;                              // 0x0154 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class TArray<struct FSoundThemeBinding>            SoundThemes;                                   // 0x0164 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	uint8_t                                            TimingMode;                                    // 0x0174 (0x0001) [0x0000000000000000]               
	uint8_t                                            RenderTextureMode;                             // 0x0175 (0x0001) [0x0000000000000000]               
	uint8_t                                            Priority;                                      // 0x0176 (0x0001) [0x0000000000000000]               
	uint8_t                                            UnknownData01[0x1];                              // 0x0177 (0x0001) MISSED OFFSET
	class TArray<struct FGFxWidgetBinding>             WidgetBindings;                                // 0x0178 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint8_t                                            UnknownData02[0x48];                            // 0x0188 (0x0048) MISSED OFFSET
...
public:
	...
	void PlaySoundFromThemeW(const class FName& EventName, const class FName& optionalSoundThemeName);
	...
	bool eventFilterButtonInput(int32_t ControllerId, const class FName& ButtonName, uint8_t InputEvent);
...
{
public:
	int32_t                                            Value[12];                                     // 0x0068 (0x0030) [0x0000000000001002] (CPF_Const | CPF_Native)
	class TArray<struct FGFxWidgetBinding>             SubWidgetBindings;                             // 0x0098 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	class TArray<uint8_t>                              RawData;                                       // 0x0068 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
	class TArray<class FString>                        ReferencedSwfs;                                // 0x0078 (0x0010) [0x0000000000420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink)
	class TArray<class UObject*>                       References;                                    // 0x0088 (0x0010) [0x0000000000420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink)
	class TArray<class UObject*>                       UserReferences;                                // 0x0098 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	...
	class FString                                      SourceFile;                                    // 0x00AC (0x0010) [0x0000000800400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditorOnly)
	int32_t                                            PackTextureSize;                               // 0x00BC (0x0004) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                            TextureRescale;                                // 0x00C0 (0x0001) [0x0000000000000001] (CPF_Edit)    
	...
	class FString                                      SourceFileTimestamp;                           // 0x00D4 (0x0010) [0x0000000800420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink | CPF_EditorOnly)
	int32_t                                            RTTextures;                                    // 0x00E4 (0x0004) [0x0000000000000000]               
	int32_t                                            RTVideoTextures;                               // 0x00E8 (0x0004) [0x0000000000000000]               
	struct FQWord                                      ImportTimeStamp;                               // 0x00EC (0x0008) [0x0000000800002002] (CPF_Const | CPF_Transient | CPF_EditorOnly)
...
public:
	...
	class TArray<struct FASValue>                      Arguments;                                     // 0x0170 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	...
	uint8_t                                            RenderTextureMode;                             // 0x0174 (0x0001) [0x0000000000000001] (CPF_Edit)    
	...
	class TArray<class FName>                          CaptureKeys;                                   // 0x0180 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<class FName>                          FocusIgnoreKeys;                               // 0x0190 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0158 (0x0008) [0x0000000000000000]               
	class TArray<class FName>                          CaptureKeys;                                   // 0x0160 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
