...
struct UGameAICommand_eventDrawDebug_Params
{
	...
	class FName                                        Category;                                         // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
...
struct UGameCheatManager_execOnRequestComplete_Params
{
	...
	// class TArray<class FString>                     Headers;                                          // 0x0014 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct AGameCrowdAgent_execInitializeAgent_Params
{
	...
	class TArray<struct FCrowdSpawnerPlayerInfo>       PlayerInfo;                                       // 0x0008 (0x0010) [0x0000000000400182] (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
	...
	// class TArray<struct FVector>                    TryOptions;                                       // 0x00AC (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
	class TArray<struct FBehaviorEntry>                BehaviorList;                                     // 0x0000 (0x0010) [0x0000000000400080] (CPF_Parm | CPF_NeedCtorLink)
...
{
	class TArray<struct FCrowdSpawnerPlayerInfo>       PlayerInfo;                                       // 0x0000 (0x0010) [0x0000000000400182] (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
...
struct AGameCrowdDestination_execPickNewDestinationFor_Params
{
	...
	// class TArray<class AGameCrowdDestination*>      DestOptions;                                      // 0x0018 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
{
	class TArray<struct FCrowdSpawnerPlayerInfo>       out_PlayerInfo;                                   // 0x0000 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
	uint32_t                                           ReturnValue : 1;                                  // 0x0010 (0x0004) [0x0000000000000580] [0x00000001] (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
};
...
struct AGameCrowdPopulationManager_execDisplayDebug_Params
{
	...
	// int32_t                                         DistanceBucket[20];                               // 0x0028 (0x0050) [0x0000000000000000]               
	...
	// class TArray<class AGameCrowdAgent*>            AgentList;                                        // 0x00AC (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct AGameExplosionActor_execDoExplosionDamage_Params
{
	...
	// class TArray<class AActor*>                     VictimsList;                                      // 0x0074 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
	// int32_t                                         I;                                                // 0x0000 (0x0004) [0x0000000000000000]               
	// class TArray<uint8_t>                           boolVars;                                         // 0x0004 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
{
	// class TArray<class USequenceObject*>            HudEvents;                                        // 0x0000 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct AMobileHUD_execDrawInputZoneOverlays_Params
{
	...
	// class TArray<class UMobileInputZone*>           Zones;                                            // 0x0018 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
{
	class TArray<class UMobileInputZone*>              ReturnValue;                                      // 0x0000 (0x0010) [0x0000000000400580] (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
};
...
{
	// class TArray<class USequenceObject*>            MobileInputSeqEvents;                             // 0x0000 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	// class USequence*                                GameSeq;                                          // 0x0010 (0x0008) [0x0000000000000000]               
	// int32_t                                         I;                                                // 0x0018 (0x0004) [0x0000000000000000]               
};
...
struct UNavMeshPath_BiasAgainstPolysWithinDistanceOfLocations_execBiasAgainstPolysWithinDistanceOfLocations_Params
{
	...
	class TArray<struct FVector>                       InLocationsToCheck;                               // 0x0024 (0x0010) [0x0000000000400082] (CPF_Const | CPF_Parm | CPF_NeedCtorLink)
...
struct UGameThirdPersonCamera_execSetFocusOnActor_Params
{
	...
	class FName                                        FocusBoneName;                                    // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
...
struct UGameSpecialMove_execInitSpecialMove_Params
{
	...
	class FName                                        InHandle;                                         // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
...
struct APlayerCollectorGame_eventGetSeamlessTravelActorList_Params
{
	...
	class TArray<class AActor*>                        ActorList;                                        // 0x0004 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
};
