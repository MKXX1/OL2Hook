...
// [0x00024002] 
struct UGFxMoviePlayer_execPlaySoundFromThemeW_Params
{
...
struct UGFxMoviePlayer_execSetVariableIntArray_Params
{
	class FString                                      Path;                                             // 0x0000 (0x0010) [0x0000000000400080] (CPF_Parm | CPF_NeedCtorLink)
	int32_t                                            Index;                                            // 0x0010 (0x0004) [0x0000000000000080] (CPF_Parm)    
	class TArray<int32_t>                              Arg;                                              // 0x0014 (0x0010) [0x0000000000400080] (CPF_Parm | CPF_NeedCtorLink)
	uint32_t                                           ReturnValue : 1;                                  // 0x0024 (0x0004) [0x0000000000000580] [0x00000001] (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
};
...
struct UGFxMoviePlayer_execGetVariableIntArray_Params
{
	class FString                                      Path;                                             // 0x0000 (0x0010) [0x0000000000400080] (CPF_Parm | CPF_NeedCtorLink)
	int32_t                                            Index;                                            // 0x0010 (0x0004) [0x0000000000000080] (CPF_Parm)    
	class TArray<int32_t>                              Arg;                                              // 0x0014 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
	uint32_t                                           ReturnValue : 1;                                  // 0x0024 (0x0004) [0x0000000000000580] [0x00000001] (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
};
