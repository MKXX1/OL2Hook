...
{
	EDebugBreakType_DEBUGGER_NativeOnly                = 0,
	EDebugBreakType_DEBUGGER_ScriptOnly                = 1,
	EDebugBreakType_DEBUGGER_Both                      = 2,
	EDebugBreakType_DEBUGGER_END                       = 3
};

// Enum Core.Object.EAutomatedRunResult
enum EAutomatedRunResult
{
	EAutomatedRunResult_ARR_Unknown                    = 0,
	EAutomatedRunResult_ARR_OOM                        = 1,
	EAutomatedRunResult_ARR_Passed                     = 2,
	EAutomatedRunResult_ARR_END                        = 3
};

// Enum Core.Object.EAspectRatioAxisConstraint
enum EAspectRatioAxisConstraint
{
	EAspectRatioAxisConstraint_AspectRatio_MaintainYFOV = 0,
	EAspectRatioAxisConstraint_AspectRatio_MaintainXFOV = 1,
	EAspectRatioAxisConstraint_AspectRatio_MajorAxisFOV = 2,
	EAspectRatioAxisConstraint_AspectRatio_END         = 3
};

// Enum Core.Object.EInterpCurveMode
enum EInterpCurveMode
{
	EInterpCurveMode_CIM_Linear                        = 0,
	EInterpCurveMode_CIM_CurveAuto                     = 1,
	EInterpCurveMode_CIM_Constant                      = 2,
	EInterpCurveMode_CIM_CurveUser                     = 3,
	EInterpCurveMode_CIM_CurveBreak                    = 4,
	EInterpCurveMode_CIM_CurveAutoClamped              = 5,
	EInterpCurveMode_CIM_END                           = 6
};

// Enum Core.Object.EInterpMethodType
enum EInterpMethodType
{
	EInterpMethodType_IMT_UseFixedTangentEvalAndNewAutoTangents = 0,
	EInterpMethodType_IMT_UseFixedTangentEval          = 1,
	EInterpMethodType_IMT_UseBrokenTangentEval         = 2,
	EInterpMethodType_IMT_END                          = 3
};
...
enum ETickingGroup
{
	ETickingGroup_TG_PreAsyncWork                      = 0,
	ETickingGroup_TG_DuringAsyncWork                   = 1,
	ETickingGroup_TG_PostAsyncWork                     = 2,
	ETickingGroup_TG_PostUpdateWork                    = 3,
	ETickingGroup_TG_EffectsUpdateWork                 = 4,
	ETickingGroup_TG_END                               = 5
};

// Enum Core.Object.GameFlowVisibilityAction
enum EGameFlowVisibilityAction
{
	EGameFlowVisibilityAction_GFVA_Hide                = 0,
	EGameFlowVisibilityAction_GFVA_Unhide              = 1,
	EGameFlowVisibilityAction_GFVA_END                 = 2
};

// Enum Core.Object.GameFlowEnableAction
enum EGameFlowEnableAction
{
	EGameFlowEnableAction_GFEA_Enable                  = 0,
	EGameFlowEnableAction_GFEA_Disable                 = 1,
	EGameFlowEnableAction_GFEA_END                     = 2
};

// Enum Core.Object.GameFlowCondition
enum EGameFlowCondition
{
	EGameFlowCondition_GFC_CheckpointReached           = 0,
	EGameFlowCondition_GFC_CheckpointUnreached         = 1,
	EGameFlowCondition_GFC_CheckpointCurrent           = 2,
	EGameFlowCondition_GFC_CheckpointCompleted         = 3,
	EGameFlowCondition_GFC_CheckpointInRange           = 4,
	EGameFlowCondition_GFC_GameStateInactive           = 5,
	EGameFlowCondition_GFC_GameStateActive             = 6,
	EGameFlowCondition_GFC_Always                      = 7,
	EGameFlowCondition_GFC_END                         = 8
};

// Enum Core.Object.EInputEvent
enum EInputEvent
{
	EInputEvent_IE_Pressed                             = 0,
	EInputEvent_IE_Released                            = 1,
	EInputEvent_IE_Repeat                              = 2,
	EInputEvent_IE_DoubleClick                         = 3,
	EInputEvent_IE_Axis                                = 4,
	EInputEvent_IE_END                                 = 5
};

// Enum Core.Object.AlphaBlendType
enum EAlphaBlendType
{
	EAlphaBlendType_ABT_Linear                         = 0,
	EAlphaBlendType_ABT_Cubic                          = 1,
	EAlphaBlendType_ABT_Sinusoidal                     = 2,
	EAlphaBlendType_ABT_EaseInOutExponent2             = 3,
	EAlphaBlendType_ABT_EaseInOutExponent3             = 4,
	EAlphaBlendType_ABT_EaseInOutExponent4             = 5,
	EAlphaBlendType_ABT_EaseInOutExponent5             = 6,
	EAlphaBlendType_ABT_END                            = 7
};

// Enum Core.DistributionVector.EDistributionVectorLockFlags
enum EDistributionVectorLockFlags
{
	EDistributionVectorLockFlags_EDVLF_None            = 0,
	EDistributionVectorLockFlags_EDVLF_XY              = 1,
	EDistributionVectorLockFlags_EDVLF_XZ              = 2,
	EDistributionVectorLockFlags_EDVLF_YZ              = 3,
	EDistributionVectorLockFlags_EDVLF_XYZ             = 4,
	EDistributionVectorLockFlags_EDVLF_END             = 5
};

// Enum Core.DistributionVector.EDistributionVectorMirrorFlags
enum EDistributionVectorMirrorFlags
{
	EDistributionVectorMirrorFlags_EDVMF_Same          = 0,
	EDistributionVectorMirrorFlags_EDVMF_Different     = 1,
	EDistributionVectorMirrorFlags_EDVMF_Mirror        = 2,
	EDistributionVectorMirrorFlags_EDVMF_END           = 3
};
...
public:
	...
	class FName                                        Name;                                          // 0x0050 (0x0008) [0x0000000000021003] (CPF_Edit | CPF_Const | CPF_Native | CPF_EditConst)
...
public:
	...
	static void DebugBreak(int32_t optionalUserFlags, uint8_t optionalDebuggerType);
	...
	static struct FVector MatrixGetAxis(const struct FMatrix& TM, uint8_t Axis);
	...
	void ProcessEvent(class UFunction* Function, void* Parms, void* Result = nullptr);
};

// Class Core.TextBuffer
// 0x002C (0x0068 - 0x0094)
...
public:
	...
	class TArray<class FString>                        Paths;                                         // 0x00B4 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        SeekFreePCPaths;                               // 0x00C4 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        ScriptPaths;                                   // 0x00D4 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        FRScriptPaths;                                 // 0x00E4 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        CutdownPaths;                                  // 0x00F4 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FName>                          Suppress;                                      // 0x0104 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        Extensions;                                    // 0x0114 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        SeekFreePCExtensions;                          // 0x0124 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<class FString>                        LocalizationPaths;                             // 0x0134 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
...
public:
	...
	class UStruct* SuperStruct; // 0x0080 (0x0008)
...
{
public:
	uint32_t FunctionFlags; // 0x00D8 (0x0004)
	uint16_t iNative; // 0x00DC (0x0002)
	uint8_t UnknownData00[0x22];// 0x00DE (0x0022) DYNAMIC FIELD PADDING
...
public:
	...
	uint8_t UnknownData00[0x14];// 0x0080 (0x0014) DYNAMIC FIELD PADDING
	int32_t Offset; // 0x0094 (0x0004)
...
{
public:
	class UClass* MetaClass; // 0x00B8 (0x0008)
...
{
public:
	uint8_t                                            UnknownData00[0x10];                            // 0x00B0 (0x0010) MISSED OFFSET
...
{
public:
	uint32_t BitMask; // 0x00B0 (0x0004)
...
public:
	...
	class TArray<class FString>                        Formats;                                       // 0x0088 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	class TArray<class FString>                        ValidGameNames;                                // 0x00A0 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	uint8_t                                            UnknownData00[0x8];                              // 0x0068 (0x0008) MISSED OFFSET
	class TArray<class FString>                        FormatExtension;                               // 0x0070 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class TArray<class FString>                        FormatDescription;                             // 0x0080 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class FName                                        TemplateName;                                  // 0x0070 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
...
public:
	...
	class TArray<class FString>                        HelpParamNames;                                // 0x0098 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class TArray<class FString>                        HelpParamDescriptions;                         // 0x00A8 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
